...
-- LOCAL PLAYER TAB
-- ========================================
local SectionLP1 = Player:Section({Title = "Movement"})
...
local SectionLP2 = Player:Section({Title = "Player Mods"})
...
local SectionLP3 = Player:Section({Title = "Team"})
...
local SectionLP4 = Player:Section({Title = "Stats"})
...
SectionLP4:Button({
    ...
    Callback = function()
        ...
        WindUI:Notify({Title="Codes", Desc="All codes redeemed!", Duration=3})
    end
})
...
Section2 = Discord:Section({Title = "Status"})
Section2:Paragraph({Title = "Script Made By Obii, But  half skidded"})
Section2:Paragraph({Title = "orchidx:I'M skid 🤓"})

-- /// TAB SHOP
Section3 = Shop:Section({Title = "Fighting Style"})
...
Section4 = Shop:Section({Title = "Sword"})
Section4:Button({
...
Section5 = Shop:Section({Title = "Gun"})
Section5:Button({
...
Section6 = Shop:Section({Title = "Skills"})
Section6:Button({
...
Section7 = Shop:Section({Title = "Other"})
Section7:Button({
...
--//// TAB STATUS 
Status = Status1:Section({Title = "Status"})

Time = Status:Paragraph({Title = "Time Zone: "})
...
ServerTime = Status:Paragraph({Title = "Time: "})
...
Miragecheck = Status:Paragraph({Title = "Mirage Island:  "})
...
Kitsunecheck = Status:Paragraph({Title = "Kitsune Island: "})
...
CPrehistoriccheck = Status:Paragraph({Title = "Prehistoric Island: "})
...
FrozenIsland = Status:Paragraph({Title = "Frozen Dimension: "})
...
MobCakePrince = Status:Paragraph({Title = "Dimension Killed: "})
...
CheckRip = Status:Paragraph({Title = "Rip_Indra: "})
...
CheckDoughKing = Status:Paragraph({Title = "Dough King: "})
...
EliteHunter = Status:Paragraph({Title = "Elite Hunter: "})
...
FM = Status:Paragraph({Title = "Full Moon: "})
...
LegendarySword = Status:Paragraph({Title = "Legendary Sword: "})
...
-- Tyrant
TyrantStatus = Status:Paragraph({Title = "Tyrant Of The Skies: "})
...
-- Pull Lever
Pullever = Status:Paragraph({Title = "Pull Lever: "})
...
-- Bone
Bone = Status:Paragraph({Title = "Bones: "})
...
Server = Status1:Section({Title = "Server"})

JobInput = Server:Input({
...
Section7 = Farm:Section({Title = "Main Farm"})
Section7:Dropdown({
    Title = "Select weapon",
...
Section8 = Farm:Section({Title = "Other Farm"})
...
Section9 = Farm:Section({Title = "Collect"})
Section9:Toggle({
...
Section10 = Farm:Section({Title = "Materials"})
...
Section11 = Farm:Section({Title = "Bones"})
Section11:Toggle({
...
Section12 = Farm:Section({Title = "Rip Indra"})
Section12:Toggle({
...
Section13 = Setting:Section({Title = "Save config"})
Section13:Button({
    Title = "Save config",
    Callback = function()
...
Section13:Button({
    ...
    Callback = function()
        if isfile and isfile(FullPath) then
            ...
            game.StarterGui:SetCore("SendNotification", {
                Title = "Tuan Config",
                Title = "No file found to delete",
                Duration = 3
            })
        end
    end
})
Section14 = Setting:Section({Title = "Setting Farm"})
Section14:Button({
    Title = "Stop flying",
    Callback = function()
        local plr = game.Players.LocalPlayer
...
Section15 = Setting:Section({Title = "Customize"})
Section15:Input({
...
Section16 = Setting:Section({Title = "Code"})
Section16:Button({
    Title = "Redeem All Codes",
    Callback = function()
        local Codes = {
...
Section17 = Setting:Section({Title = "Team"})
Section17:Button({
...
Section18 = Setting:Section({Title = "Other"})
HakiSt = {
    "State 0",
    "State 1",
    "State 2",
...
Section20 = Others:Section({Title = "Fishing"})
...
Section21 = Others:Section({Title = "Boss Farm"})
WS = game:GetService("Workspace")
RS = game:GetService("ReplicatedStorage")
...
-- LABEL
BossStatus = Section21:Paragraph({Title = "Boss Status: Loading..."})
...
BossDropdown = Section21:Dropdown({
Title = "Select Boss",
...
Section22 = Others:Section({Title = "Quests"})
Section22:Toggle({
		...
		if _G.AutoKenVTWO then
			pcall(function()
				...
				if not plr.Backpack:FindFirstChild("Fruit Bowl") or not plr.Character:FindFirstChild("Fruit Bowl") then
					...
					if plr.Backpack:FindFirstChild("Nexus") and (plr.Backpack:FindFirstChild("Apple") and plr.Backpack:FindFirstChild("Pineapple")) or plr:FindFirstChild("Nexus") and (plr:FindFirstChild("Apple") and plr:FindFirstChild("Pineapple")) then
						repeat
							task.wait();
							_tp(I);
...
Section23 = Others:Section({Title = "Sword"})
Section23:Toggle({
...
Section24 = Others:Section({Title = "Color Haki"})
Section24:Toggle({
...
Section25 = Event:Section({Title = "Sea"})
-- Select Boat
Section25:Dropdown({
    Title = "Select Boat",
    Values = {
...
Section26 = Event:Section({Title = "Auto sea event"})
Section26:Toggle({
...
Section27 = Event:Section({Title = "Leviathan"})
Section27:Button({
    Title = "Bribe spy",
    Callback = function()
...
Section28 = Event:Section({Title = "Kitsune Island"})
Section28:Toggle({
...
Section29 = Event:Section({Title = "Mysterious Island"})
Section29:Toggle({
...
Section30 = Event:Section({Title = "Magma Magnet"})
...
Section31 = Event:Section({Title = "Volcanic Island"})
...
Section32 = Event:Section({Title = "Skill Settings - Fighting Style"})
...
Section33 = Event:Section({Title = "Skill Settings - Sword"})
...
Section34 = Event:Section({Title = "Skill Settings - Gun"})
...
Section35 = Event:Section({Title = "Skill Settings - Fruit"})
...
Section36 = Maestry:Section({Title = "Mastery"})
...
Section37 = Race:Section({Title = "Upgrade"})
...
Section38 = Race:Section({Title = "Race V4"})
-- Remember to add this line at the very top of the script if not already there:
plr = game.Players.LocalPlayer 

-- Initialize Label
K5 = Section38:Paragraph({Title = "V4 status: Loading..."})
...
Section39 = Dojo:Section({Title = "Quests"})
...
Section40 = Dojo:Section({Title = "Draco Race"})
...
-- GN VO UI
-- ==========================================
Section41 = Esp:Section({Title = "Esp"})
...
Section42 = Front:Section({Title = "Text ESP"})
...
Section43 = Esp:Section({Title = "Stats"})
...
do
SectionGet1 = Get:Section({Title = "Accessories"})
SectionGet1:Button({ Title = "Store Current Fruit", Callback = function() pcall(UpdStFruit) end })
SectionGet1:Button({ Title = "Drop Current Fruit", Callback = function() pcall(DropFruits) end })
SectionGet1:Button({ Title = "Collect Fruits on Ground", Callback = function() pcall(function() collectFruits(true) end) end })
end
do
SectionGet2 = Get:Section({Title = "Codes"})
SectionGet2:Button({
    Title = "Redeem All Codes",
    Callback = function()
        task.spawn(function()
...
-- TAB: RAID & FRUIT
do
SectionFruit1 = Fruit:Section({Title = "Auto Raid"})
SectionFruit1:Dropdown({
    Title = "Select Raid",
...
do
SectionFruit2 = Fruit:Section({Title = "Fruit Snipe"})
SectionFruit2:Dropdown({
...
Section45 = Teleport:Section({Title = "World"})
...
Section46 = Teleport:Section({Title = "Island"})
...
Section47 = Teleport:Section({Title = "Portal"})
...
Section48 = Teleport:Section({Title = "NPC"})
...
local SectionHop = Setting1:Section({Title = "Hop Servers"})
SectionHop:Button({Title="Hop: Legendary Sword",   Callback=function() game:HttpGet("http://nighthub.site/boss/SwordLegendary") end})
SectionHop:Button({Title="Hop: Legendary Haki",    Callback=function() game:HttpGet("http://nighthub.site/boss/HakiLegendary") end})
SectionHop:Button({Title="Hop: Rip Indra",         Callback=function() game:HttpGet("http://nighthub.site/boss/RipIndra") end})
SectionHop:Button({Title="Hop: Darkbeard",         Callback=function() game:HttpGet("http://nighthub.site/boss/Darkbeard") end})
SectionHop:Button({Title="Hop: Dough King",        Callback=function() game:HttpGet("http://nighthub.site/boss/DoughKing") end})
SectionHop:Button({Title="Hop: Berry",             Callback=function() game:HttpGet("http://nighthub.site/boss/Berry") end})
SectionHop:Button({Title="Hop: Tyrant of Skies",   Callback=function() game:HttpGet("http://nighthub.site/boss/TyrantOfTheSkies") end})
SectionHop:Button({Title="Hop: Cursed Captain",    Callback=function() game:HttpGet("http://nighthub.site/boss/CursedCaptain") end})
SectionHop:Button({Title="Hop: Soul Reaper",       Callback=function() game:HttpGet("http://nighthub.site/boss/SoulReaper") end})
SectionHop:Button({Title="Hop: Full Moon",         Callback=function() game:HttpGet("http://nighthub.site/boss/Fullmoon") end})
SectionHop:Button({Title="Hop: Near Moon",         Callback=function() game:HttpGet("http://nighthub.site/boss/NearMoon") end})
SectionHop:Button({Title="Hop: Mirage Island",     Callback=function() game:HttpGet("http://nighthub.site/boss/Mirage") end})
SectionHop:Button({Title="Hop: Kitsune Island",    Callback=function() game:HttpGet("http://nighthub.site/boss/KitsuneIsland") end})
SectionHop:Button({Title="Hop: Prehistoric Island",Callback=function() game:HttpGet("http://nighthub.site/boss/PrehistoricIsland") end})
